...
<body>
    ...
    <main>
        ...
        <section id="contact" class="section">
            <div class="container">
                <h1 class="title is-size-1 has-text-centered">บริษัท ทีแอนด์พี โปรเทค สำนักงานใหญ่</h1>
                <!-- Google Map -->
                ...
                <div class="columns is-multiline is-mobile contact-detail">
                    <div class="column is-6">
                        <div class="content">
                            <h6 class="title is-size-6">บริษัท ทีแอนด์พี โปรเทค จำกัด</h6>
                            <p>ที่อยู่ 411/14 ถนนจรัญสนิทวงศ์ 83 แขวงบางอ้อ เขตบางพลัด กรุงเทพฯ 10700</p>
                            <p>โทร : 063-526-9923</p>
                            <p>089-165-8886</p>
                            <p>อีเมล์  : tpprotech18@gmail.com</p>
                        </div>
                    </div>
                    <div class="column is-6">
                        <p>หรือ แสกน QR code เพื่อติดต่อเราทางไลน์</p>
                        <img src="images/contact-img/line-qr-code.jpg" alt="@tpprotech18" title="@tpprotech18">
                    </div>
                </div>
            </div>
        </section>
