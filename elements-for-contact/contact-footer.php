...
<section id="contact-banner" class="section">
    <div class="container">
        <div class="columns is-vcentered">
            <div class="column">
                <div class="content">
                    <p class="is-size-4-touch is-size-4-desktop has-text-weight-bold p-3">ติดต่อผู้เชี่ยวชาญเพื่อขอรายละเอียด</p>
                </div>
            </div>
            <div class="column">
...
<footer id="footer">
        ...
        <div class="columns">
            ...
            <div class="column">
                <div class="content footer-address is-size-6">
                    <p>บริษัท ทีแอนด์พี โพรเทค</p>
                    <p>ที่อยู่ 411/14 ถนน จรัญสนิทวงศ์ 83 แขวงบางอ้อ เขตบางพลัด กรุงเทพฯ 10700</p>
    ...
    <hr>
    <p class="has-text-centered is-uppercase mt-6"><span>&copy</span>2021 t&p protech</p>
</footer>