...
<body>
    ...
    <main>
                ...
                <div class="content">
                    <nav class="breadcrumb" aria-label="breadcrumbs">
                        <ul>
                            ...
                            <li class="is-active has-text-weight-light"><a href="#">กระดาษอัลตราซาวด์ และ EKG</a></li>
                        </ul>
                    </nav>
                </div>
            </div>
        ...
        <section id="product" class="section">
            <div class="container">
                <h1 class="title is-size-5 has-text-weight-bold has-text-centered">กระดาษอัลตราซาวด์ และ กระดาษ EKG ทางการการแพทย์</h1>
                <!-- Products list -->
                <div class="columns is-multiline is-mobile products-group">
                    <div class="column is-6">
                        <div class="content">
                            ...
                            <p class="is-size-6 has-text-weight-light mt-4">กระดาษอัลตราซาวด์</p>
                        </div>
                    </div>
                    <div class="column is-6">
                        <div class="content">
                            <img src="../images/product-groups/medical-paper/กระดาษ-EKG.jpg" alt="กระดาษ EKG" title="กระดาษ EKG">
                            <p class="is-size-6 has-text-weight-light mt-4">กระดาษ EKG</p>
                        </div>
                    </div>
                </div>
            </div>
