...
<body>
    ...
    <main>
        ...
        <section id="product" class="section">
            <div class="container">
                <h1 class="title is-size-4-touch is-size-2-desktop has-text-weight-bold has-text-centered">ผ้าพันแขนสำหรับ เครื่องวัดความดัน/ข้อต่อ</h1>
                <!-- Products list -->
                <div class="columns is-multiline is-mobile products-group">
                    <div class="column is-6">
                        <div class="content">
                            ...
                            <p class="is-size-5 has-text-weight-medium mt-4">ผ้าพันแขน เครื่องวัดความดัน</p>
                        </div>
                    </div>
                    <div class="column is-6">
                        <div class="content">
                            ...
                            <p class="is-size-5 has-text-weight-medium mt-4">ข้อต่อ เครื่องวัดความดัน</p>
                        </div>
                    </div>
                </div>
            </div>
