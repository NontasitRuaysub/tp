...
<body>
    ...
    <main>
        ...
        <section id="product" class="section">
            <div class="container">
                <h1 class="title is-size-4-touch is-size-2-desktop has-text-weight-bold has-text-centered">เครื่องเอกซเรย์</h1>
                <!-- Products list -->
