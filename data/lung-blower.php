...
<body>
    ...
    <main>
        ...
        <section id="product" class="section">
            <div class="container">
                <h1 class="title is-size-3 has-text-centered">อะไหล่ และเครื่องเป่าปอด</h1>
                <!-- Products list -->
                <div class="columns is-multiline is-mobile products-group">
                    <div class="column is-6">
                        <div class="content">
                            ...
                            <p class="is-size-4 has-text-weight-medium mt-4">SP10/SP10W</p>
                        </div>
                    </div>
                    <div class="column is-6">
                        <div class="content">
                            <img src="../images/product-groups/เครื่องเป่าปอด/SP70B.jpg" alt="SP70B" title="SP70B">
                            <p class="is-size-4 has-text-weight-medium mt-4">SP70B</p>
                        </div>
                    </div>
                    <div class="column is-6">
                        <div class="content">
                            <img src="../images/product-groups/เครื่องเป่าปอด/SP100.jpg" alt="SP100" title="SP100">
                            <p class="is-size-4 has-text-weight-medium mt-4">SP100</p>
                        </div>
                    </div>
                    <div class="column is-6">
                        <div class="content">
                            ...
                            <p class="is-size-4 has-text-weight-medium mt-4">Adapter-Spiro plastic</p>
                        </div>
                    </div>
                    <div class="column is-6">
                        <div class="content">
                            ...
                            <p class="is-size-4 has-text-weight-medium mt-4">Disposable bacteria filter</p>
                        </div>
                    </div>
                    <div class="column is-6">
                        <div class="content">
                    ...
                    <div class="column is-6">
                        <div class="content">
                            ...
                            <p class="is-size-4 has-text-weight-medium mt-4">Nebulizer with Pediatric Mask</p>
                        </div>
                    </div>
                    <div class="column is-6">
                        <div class="content">
                            ...
                            <p class="is-size-4 has-text-weight-medium mt-4">Oxygen mask with bag</p>
                        </div>
                    </div>
