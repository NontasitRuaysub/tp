...
<section id="contact-banner" class="section">
    <div class="container">
        <div class="columns is-vcentered">
            <div class="column">
                <div class="content">
                    <p class="is-size-4-mobile is-size-3-tablet has-text-weight-bold">ติดต่อสั่งซื้อสินค้า
        ...
        <div class="columns">
            ...
            <div class="column">
                <div class="content footer-address is-size-6">
                    <p>บริษัท ทีแอนด์พี โพรทีช</p>
                    <p>ที่อยู่: orem ipsum dolor sit amet, consectetur adipiscing elit. </p>
