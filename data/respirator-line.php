...
<body>
    ...
    <main>
            ...
            <div class="container">
                <nav class="breadcrumb" aria-label="breadcrumbs">
                    <ul>
                        ...
                        <li class="is-active has-text-weight-light"><a href="#">อุปกรณ์ชุดสายช่วยหายใจ</a></li>
                    </ul>
                </nav>
            </div>
        </section>
        ...
        <section id="product" class="section">
            <div class="container">
                <h1 class="title is-size-5 has-text-weight-bold has-text-centered">อุปกรณ์ชุดสายช่วยหายใจ</h1>
                <!-- Products list -->
                <div class="columns is-multiline is-mobile products-group">
                    <div class="column is-6">
                        <div class="content">
                            ...
                            <p class="is-size-6 has-text-weight-light mt-4">ชุดสายช่วยหายใจ</p>
                        </div>
                    </div>
                    <div class="column is-6">
                        <div class="content">
