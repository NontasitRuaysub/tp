...
<body>
    ...
    <main>
            ...
            <div class="container">
                <nav class="breadcrumb" aria-label="breadcrumbs">
                    <ul>
                        ...
                        <li class="is-active"><a href="#">ชุดช่วยหายใจแบบมือบีบ</a></li>
                    </ul>
                </nav>
            </div>
        </section>
        ...
        <section id="product" class="section">
            <div class="container">
                <h1 class="title is-size-4-touch is-size-2-desktop has-text-weight-bold has-text-centered">ชุดช่วยหายใจแบบมือบีบ</h1>
                <!-- Products list -->
                <div class="columns is-multiline is-mobile products-group">
                    <div class="column is-6">
                        <div class="content">
                            ...
                            <p class="is-size-5 has-text-weight-medium mt-4">ชุดช่วยหายใจแบบมือบีบ</p>
                        </div>
                    </div>
                    <div class="column is-6">
                        <div class="content">
