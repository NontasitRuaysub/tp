...
<section id="contact-banner" class="section">
    <div class="container">
        <div class="columns is-vcentered">
            <div class="column">
                <div class="content">
                    <p class="is-size-4-mobile is-size-4-desktop has-text-weight-bold p-3">ติดต่อสั่งซื้อสินค้า
...
<footer id="footer">
    ...
    <hr>
    <p class="has-text-centered is-uppercase mt-6 is-size-6"><span>&copy</span>2021 t&p protech</p>
</footer>